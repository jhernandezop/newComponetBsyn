...
class App extends Component {
  ...
  render() {
    ...
    const opciones = [
                      {opcion:"Estado", funcion:"x"},
                      {opcion:"Logoff Usuario", funcion:"x"},
                      {opcion:"Pausar", funcion:"x"},
                      {opcion:"Llamar", funcion:"x"},
                      {opcion:"Cortar", funcion:"x"},
                      {opcion:"Transferir", funcion:"x"},
                      ]
